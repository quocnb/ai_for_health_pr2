...
from section3.src.networks.RecursiveUNet import UNet
from section3.src.utils.utils import med_reshape
...
class UNetInferenceAgent:
    ...
    def single_volume_inference(self, volume):
        ...
        # <YOUR CODE HERE>
        vol_tensor = torch.from_numpy(volume).type(torch.FloatTensor).unsqueeze(1).to(self.device)
