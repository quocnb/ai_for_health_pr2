...
from section2.src.data_prep.SlicesDataset import SlicesDataset
from section2.src.utils.utils import log_to_tensorboard
from section2.src.utils.volume_stats import Dice3d, Jaccard3d
from section2.src.networks.RecursiveUNet import UNet
from section2.src.inference.UNetInferenceAgent import UNetInferenceAgent
...
class UNetExperiment:
    ...
    def loss(self, batch):
        ...
        return prediction_softmax, loss
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: Batch size, three axes (coronal, sagittal, axial)
